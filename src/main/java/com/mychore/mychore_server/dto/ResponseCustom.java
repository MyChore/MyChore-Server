...
import static com.mychore.mychore_server.global.constants.Constant.JWT_EXPIRED;
...
public class ResponseCustom<T> {
    ...
    public static <T> ResponseCustom<T> INTERNAL_SERVER_ERROR(@Nullable String description){
        return (ResponseCustom<T>) ResponseCustom.builder()
                .transaction_time(LocalDateTime.now())
                .status(HttpStatus.INTERNAL_SERVER_ERROR)
